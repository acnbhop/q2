...
!MESSAGE 
!MESSAGE NMAKE /f "ref_gl.mak" CFG="ref_gl - Win32 Release Alpha"
!MESSAGE 
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winmm.lib /nologo /subsystem:windows /dll /machine:I386 /out:"..\ref_gl_release.dll"
...
# PROP Output_Dir "..\"
# PROP Intermediate_Dir "..\objects\debug\ref_gl"
# PROP Ignore_Export_Lib 0
# PROP Target_Dir "."
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winmm.lib /nologo /subsystem:windows /dll /incremental:no /map /debug /machine:I386 /out:"..\ref_gl_debug.dll"
